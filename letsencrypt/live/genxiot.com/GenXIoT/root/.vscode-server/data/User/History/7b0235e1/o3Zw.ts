...
export class ServerSocket {
    ...
    constructor(server: HTTPServer) {
        ...
        ServerSocket.io = require("socket.io")(server, {
            ...
            handlePreflightRequest: (req: any, res: { writeHead: (arg0: number, arg1: { "Access-Control-Allow-Origin": string; "Access-Control-Allow-Methods": string; "Access-Control-Allow-Headers": string; "Access-Control-Allow-Credentials": boolean; }) => void; end: () => void; }) => {
              res.writeHead(200, {
